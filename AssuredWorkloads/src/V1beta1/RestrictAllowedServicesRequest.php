 ...
 *
 * Generated from protobuf message <code>google.cloud.assuredworkloads.v1beta1.RestrictAllowedServicesRequest</code>
 */
class RestrictAllowedServicesRequest extends \Google\Protobuf\Internal\Message
{
    /**
     ...
     *
     * Generated from protobuf field <code>.google.cloud.assuredworkloads.v1beta1.RestrictAllowedServicesRequest.RestrictionType restriction_type = 2 [(.google.api.field_behavior) = REQUIRED];</code>
     */
    ...
    {
        GPBUtil::checkEnum($var, \Google\Cloud\AssuredWorkloads\V1beta1\RestrictAllowedServicesRequest\RestrictionType::class);
