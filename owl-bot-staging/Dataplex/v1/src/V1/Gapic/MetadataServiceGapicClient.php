...
class MetadataServiceGapicClient
{
    ...
    private static function getEntityNameTemplate()
    {
        if (self::$entityNameTemplate == null) {
            self::$entityNameTemplate = new PathTemplate('projects/{project}/locations/{location}/lakes/{lake}/zones/{zone}/entities/{entity}');
        }
    ...
    private static function getPartitionNameTemplate()
    {
        if (self::$partitionNameTemplate == null) {
            self::$partitionNameTemplate = new PathTemplate('projects/{project}/locations/{location}/lakes/{lake}/zones/{zone}/entities/{entity}/partitions/{partition}');
        }
     ...
     */
    public static function entityName($project, $location, $lake, $zone, $entity)
    {
     ...
     */
    public static function partitionName($project, $location, $lake, $zone, $entity, $partition)
    {
    ...
    public function createEntity($parent, $entity, array $optionalArgs = [])
    {
        ...
        return $this->startCall('CreateEntity', Entity::class, $optionalArgs, $request)->wait();
    }
     ...
     * @throws ApiException if the remote call fails
     */
    public function createPartition($parent, $partition, array $optionalArgs = [])
    {
        ...
        $requestParams = new RequestParamsHeaderDescriptor($requestParamHeaders);
        $optionalArgs['headers'] = isset($optionalArgs['headers']) ? array_merge($requestParams->getHeader(), $optionalArgs['headers']) : $requestParams->getHeader();
        return $this->startCall('CreatePartition', Partition::class, $optionalArgs, $request)->wait();
    }
     ...
     *                             `projects/{project_number}/locations/{location_id}/lakes/{lake_id}/zones/{zone_id}/entities/{entity_id}`.
     * @param string $etag         Required. The etag associated with the entity, which can be retrieved with a
     *                             [GetEntity][] request.
     * @param array  $optionalArgs {
     *     Optional.
     *
    ...
    public function deleteEntity($name, $etag, array $optionalArgs = [])
    {
        ...
        $requestParams = new RequestParamsHeaderDescriptor($requestParamHeaders);
        $optionalArgs['headers'] = isset($optionalArgs['headers']) ? array_merge($requestParams->getHeader(), $optionalArgs['headers']) : $requestParams->getHeader();
        return $this->startCall('DeleteEntity', GPBEmpty::class, $optionalArgs, $request)->wait();
    }
    ...
    public function deletePartition($name, array $optionalArgs = [])
    {
        ...
        $requestParams = new RequestParamsHeaderDescriptor($requestParamHeaders);
        $optionalArgs['headers'] = isset($optionalArgs['headers']) ? array_merge($requestParams->getHeader(), $optionalArgs['headers']) : $requestParams->getHeader();
        return $this->startCall('DeletePartition', GPBEmpty::class, $optionalArgs, $request)->wait();
    }
    ...
    public function getEntity($name, array $optionalArgs = [])
    {
        ...
        $requestParams = new RequestParamsHeaderDescriptor($requestParamHeaders);
        $optionalArgs['headers'] = isset($optionalArgs['headers']) ? array_merge($requestParams->getHeader(), $optionalArgs['headers']) : $requestParams->getHeader();
        return $this->startCall('GetEntity', Entity::class, $optionalArgs, $request)->wait();
    }
    ...
    public function getPartition($name, array $optionalArgs = [])
    {
        ...
        $requestParams = new RequestParamsHeaderDescriptor($requestParamHeaders);
        $optionalArgs['headers'] = isset($optionalArgs['headers']) ? array_merge($requestParams->getHeader(), $optionalArgs['headers']) : $requestParams->getHeader();
        return $this->startCall('GetPartition', Partition::class, $optionalArgs, $request)->wait();
    }
    ...
    public function listEntities($parent, $view, array $optionalArgs = [])
    {
        ...
        $requestParams = new RequestParamsHeaderDescriptor($requestParamHeaders);
        $optionalArgs['headers'] = isset($optionalArgs['headers']) ? array_merge($requestParams->getHeader(), $optionalArgs['headers']) : $requestParams->getHeader();
        return $this->getPagedListResponse('ListEntities', $optionalArgs, ListEntitiesResponse::class, $request);
    }
    ...
    public function listPartitions($parent, array $optionalArgs = [])
    {
        ...
        $requestParams = new RequestParamsHeaderDescriptor($requestParamHeaders);
        $optionalArgs['headers'] = isset($optionalArgs['headers']) ? array_merge($requestParams->getHeader(), $optionalArgs['headers']) : $requestParams->getHeader();
        return $this->getPagedListResponse('ListPartitions', $optionalArgs, ListPartitionsResponse::class, $request);
    }
    ...
    public function updateEntity($entity, array $optionalArgs = [])
    {
        ...
        $requestParams = new RequestParamsHeaderDescriptor($requestParamHeaders);
        $optionalArgs['headers'] = isset($optionalArgs['headers']) ? array_merge($requestParams->getHeader(), $optionalArgs['headers']) : $requestParams->getHeader();
        return $this->startCall('UpdateEntity', Entity::class, $optionalArgs, $request)->wait();
    }
