...
class ContentServiceGapicClient
{
    ...
    private static function getContentNameTemplate()
    {
        if (self::$contentNameTemplate == null) {
            self::$contentNameTemplate = new PathTemplate('projects/{project}/locations/{location}/lakes/{lake}/content/{content}');
        }
    ...
    public function createContent($parent, $content, array $optionalArgs = [])
    {
        ...
        return $this->startCall('CreateContent', Content::class, $optionalArgs, $request)->wait();
    }
    ...
    public function deleteContent($name, array $optionalArgs = [])
    {
        ...
        $requestParams = new RequestParamsHeaderDescriptor($requestParamHeaders);
        $optionalArgs['headers'] = isset($optionalArgs['headers']) ? array_merge($requestParams->getHeader(), $optionalArgs['headers']) : $requestParams->getHeader();
        return $this->startCall('DeleteContent', GPBEmpty::class, $optionalArgs, $request)->wait();
    }
    ...
    public function getContent($name, array $optionalArgs = [])
    {
        ...
        $requestParams = new RequestParamsHeaderDescriptor($requestParamHeaders);
        $optionalArgs['headers'] = isset($optionalArgs['headers']) ? array_merge($requestParams->getHeader(), $optionalArgs['headers']) : $requestParams->getHeader();
        return $this->startCall('GetContent', Content::class, $optionalArgs, $request)->wait();
    }
    ...
    public function listContent($parent, array $optionalArgs = [])
    {
        ...
        $requestParams = new RequestParamsHeaderDescriptor($requestParamHeaders);
        $optionalArgs['headers'] = isset($optionalArgs['headers']) ? array_merge($requestParams->getHeader(), $optionalArgs['headers']) : $requestParams->getHeader();
        return $this->getPagedListResponse('ListContent', $optionalArgs, ListContentResponse::class, $request);
    }
     ...
     * @throws ApiException if the remote call fails
     */
    public function updateContent($updateMask, $content, array $optionalArgs = [])
    {
        ...
        $requestParams = new RequestParamsHeaderDescriptor($requestParamHeaders);
        $optionalArgs['headers'] = isset($optionalArgs['headers']) ? array_merge($requestParams->getHeader(), $optionalArgs['headers']) : $requestParams->getHeader();
        return $this->startCall('UpdateContent', Content::class, $optionalArgs, $request)->wait();
    }
